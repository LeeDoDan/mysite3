            ...
            <div id="board">
               <div id="list">
                  ...
                  <table >
                     ...
                     <tbody>
                        <!-- Controller의 model.addAttribute("boardList",boardList); --><!-- 5개중하나만 쓸건데 하나담을수있는 이름 list보단.. -->
                        <c:forEach items="${requestScope.boardList}" var="boardVo">
                           <tr>										
                              ...
                              <td>${boardVo.name}</td>
                              <td>${boardVo.hit}</td>
                              <td>${boardVo.regDate} /글 작성자 번호: ${boardVo.userNo} /세션:${sessionScope.authUser.no}</td>
                              <td>
                              	<!-- 글 작성자 번호와 세션의 사용자 번호(로그인한) 같으면 삭제버튼이 보임 -->
                              	<c:if test="${boardVo.userNo == sessionScope.authUser.no }"><!-- 하나의문법 합쳐서{} 써야함 -->
