	...
	<div id="wrap">
		...
		<div id="content">
			...
			<div id="gallery">
				...
				<c:if test="${galleryVo.userNo != sessionScope.authUser.no }">
                    <button id="btnImgUpload">이미지올리기</button>
                </c:if>  
					
					<div class="clear"></div>

					<!-- <form action="${pageContext.request.contextPath}/gallery/add" method="get"> -->
						<ul id="viewArea">
							...
							<c:forEach items="${galleryList}" var="galleryList">
								<li id="viewList">
									<div class="view">
										...
										<div class="imgWriter">
											작성자: <strong>${galleryList.userVo.name}</strong>
										</div>
									</div>
								</li>
							</c:forEach>
				...
				<form method="post" action="${pageContext.request.contextPath}/gallery/add" enctype="multipart/form-data">
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<input id=""  name="userNo" type="hidden" value="${sessionScope.authUser.no}" >
						</div>
					</div>
	...
	<div class="modal fade" id="viewModal">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form method="get" action="${pageContext.request.contextPath}/gallery/list">
					<div class="modal-footer">
