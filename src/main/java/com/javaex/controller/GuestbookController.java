...
public class GuestbookController {
	...
	public String addList(Model model) {
		System.out.println("UestbookController.addList()");
	...
	public String add(@ModelAttribute GuestbookVo guestbookVo) {
		System.out.println("UestbookController.add()");
	...
	public String delete(@ModelAttribute GuestbookVo guestbookVo) {
		System.out.println("UestbookController.delete()");
	...
	public String deleteForm(@ModelAttribute GuestbookVo guestbookVo, @RequestParam("no") int no) {//no의 파라미터가져와서~~
		System.out.println("UestbookController.deleteForm()");
